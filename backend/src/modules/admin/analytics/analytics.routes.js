...
import { analyticsQuery } from "../admin.schemas.js";
import { dateFilter } from "../admin.helpers.js";
...
adminAnalyticsRouter.get(
  ...
  asyncWrapper(async (req, res) => {
    ...
    const invoiceWhere = { deleted_at: null, payment_status: "completed" };
    const orderWhere = { payment_status: "completed" };
    ...
    const serviceRevenue = new Decimal(_nullishCoalesce(invoiceAgg._sum.total, () => ( 0)));
    const orderRevenue = new Decimal(_nullishCoalesce(orderAgg._sum.total, () => ( 0)));
...
adminAnalyticsRouter.get(
  ...
  asyncWrapper(async (req, res) => {
    ...
    const jobWhere = { deleted_at: null };
