      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
        <header className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <h1 className="text-xl font-semibold">User Dashboard (Phase 1)</h1>
        ...
        <section className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Next: `/user/vehicles/new`</p>
          </article>
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <h2 className="font-semibold">Raise New Issue</h2>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Next: `/user/requests/new`</p>
          </article>
          <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <h2 className="font-semibold">My Requests</h2>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Next: `/user/requests`</p>
          </article>
        </section>
      </div>
    </div>
